...
/**
 * Contains options to apply when updating the displayed damage counter score
 */
declare type ScoreUpdateOptions = {
	shouldShake: boolean;
}
...
declare class GameObject extends Entity {
	...
	findStatusEffectObjectsByTag(type: number, tag: string): {id: string, options?: {fields?: {frameTimer?: TFrameTimer}, metadata?: any, params?: {collisionBoxType?: number, interval?: number}, tag?: string}, type: number, value: number}[];
...
declare interface Character extends GameObject, TCharacter {
	 ...
	 * @return True if the character is free to act.
	 */
	inActionableState(): boolean;
	endAnimation(): void;
	/**
	 * Returns the total number of wall jumps the character has performed this airtime
	 * @return Int
	 */
	getTotalWallJumps(): number;
	/**
	 ...
	 *
	 * The character's state is not taken into account, only if the structure's ledge is available.
	 * @param structure Structure to attempt to ledge-grab
	 * @param isLeftLedge Bool True if the left ledge is to be grabbed, False if the right ledge is to be grabbed
	 * @return Bool True if the character grabbed the ledge
	 */
	attemptStructureLedgeGrab(structure: Structure, isLeftLedge: boolean): boolean;
	/**
	 ...
	 *
	 * @param state The state to re-enable. If not specified, will re-enable all states
	 */
	resetSingleUse(state: number): void;
	/**
...
declare interface TCharacter {
	...
	/**
	 * Update the score that should be displayed on the damage counter.
	 * Not necessarily the score used to determine the winner.
	 */
	setDamageCounterScore(newScore: number, options?: ScoreUpdateOptions): void;
	/**
	 * Get the score that is currently displayed on the damage counter.
	 * Not necessarily the score used to determine the winner.
	 */
	...
	/**
	 * Transitions the entity to a new state, taking into account the object's state transition map and animation rules. Note that the the target state is not guaranteed to be the current state after this function is called, so it's important to check the state after calling this function if you need to know the result.
	 * Respects turbo mode cancel logic
	 * @param state The state to transition to.
	 * @param animationOverride Overrides the animation to use for the state transition.
	 */
...
declare interface TMatch {
	...
	createVfx(vfxStats: VfxStats, owner?: GameObject): Vfx;
	/**
	 * Returns true if the provided match modifier is active.
	 * @param modifier The match modifier to check for
	 * @see MatchModifier
	 * @return Bool
	 */
...
declare class MatchModifier {
	...
	static LIGHT: number;
	static HEAVY: number;
	static REVERSE_KNOCKBACK: number;
	static RANDOM_KNOCKBACK: number;
	static VAMPIRE: number;
	static VENGEANCE: number;
	static INVISIBLE: number;
	static STEALTH: number;
	static TURBO: number;
	static AUTOJUMP: number;
	static INFINITE_JUMPS: number;
	static INFINITE_ASSIST: number;
	static INSTANT_ASSIST: number;
	static isModifierActive(match: Match, modifier: number): boolean;
}
...
declare class MatchSettingsConfig extends JSONClass {
	 ...
	 * Any player-affecting parameters will be overridden by the PlayerConfig.
	 */
	constructor(settings: {damageDisplay?: boolean, damageMode?: boolean, damageRatio?: number, entrances?: boolean, hazards?: boolean, intro?: HudIntroConfig, lives?: number, matchRules?: {contentId: string, namespace: string, resourceId: string}[], metadata?: any, music?: {contentId: string, namespace: string, resourceId: string}, netcodeInputBuffer?: number, netcodeType?: number, pauseMenuId?: string, playerIDs?: boolean, preloadMediaMap?: any, randSeed?: string, scoreDisplay?: boolean, selfDestructScore?: number, sizeRatio?: number, specialModes?: number, stage?: {contentId: string, namespace: string, resourceId: string}, startAssistCharge?: number, startDamage?: number, teamAttack?: boolean, teams?: boolean, time?: number});
	/**
	...
	/**
	 * Starting assist charge for players.
	 */
	startAssistCharge: number;
	/**
	 * Intro Animation Sprite and Animation Configuration
	 */
	intro: HudIntroConfig;
	/**
	 * Set to true to display the player score on the HUD if in time mode. Set to false to hide it.
	 */
...
declare var GlobalSfx:GlobalSfx;
declare type GlobalSfx = TGlobalSfx & {
	constructor();
	PARRY: string;
	HIT_LIGHT: string;
	HIT_MEDIUM: string;
	...
	CRASH_NORMAL: string;
	GRAB_CONFIRM: string;
	GROUND_BOUNCE: string;
	KO_BLAST: string;
	GROUNDED_SPIKE: string;
	CRASH_1: string;
	CRASH_2: string;
	DOUBLE_JUMP: string;
	FATAL_BASH: string;
	FATAL_WIND_HIT: string;
	FATAL_FIRE_HIT: string;
	FATAL_ELECTRIC_HIT: string;
	FATAL_ICE_HIT: string;
	FATAL_MAGIC_HIT: string;
	FATAL_WATER_HIT: string;
	FATAL_DARKNESS_HIT: string;
	FATAL_KICK: string;
	FATAL_POISON_HIT: string;
	FATAL_PUNCH: string;
	FATAL_SLAM: string;
	FATAL_SLICE: string;
	FATAL_WHACK: string;
	STRONG_CHARGE: string;
	STRONG_CLICK: string;
	HEAVY_BASH: string;
	HEAVY_WIND_HIT: string;
	HEAVY_FIRE_HIT: string;
	HEAVY_ELECTRIC_HIT: string;
	HEAVY_ICE_HIT: string;
	HEAVY_MAGIC_HIT: string;
	HEAVY_WATER_HIT: string;
	HEAVY_DARKNESS_HIT: string;
	HEAVY_KICK: string;
	HEAVY_POISON_HIT: string;
	HEAVY_PUNCH: string;
	HEAVY_SLAM: string;
	HEAVY_SLICE: string;
	HEAVY_WHACK: string;
	LAND: string;
	LIGHT_BASH: string;
	LIGHT_WIND_HIT: string;
	LIGHT_FIRE_HIT: string;
	LIGHT_ELECTRIC_HIT: string;
	LIGHT_ICE_HIT: string;
	LIGHT_MAGIC_HIT: string;
	LIGHT_WATER_HIT: string;
	LIGHT_DARKNESS_HIT: string;
	LIGHT_KICK: string;
	LIGHT_POISON_HIT: string;
	LIGHT_PUNCH: string;
	LIGHT_SLAM: string;
	LIGHT_SLICE: string;
	LIGHT_WHACK: string;
	MEDIUM_BASH: string;
	MEDIUM_WIND_HIT: string;
	MEDIUM_FIRE_HIT: string;
	MEDIUM_ELECTRIC_HIT: string;
	MEDIUM_ICE_HIT: string;
	MEDIUM_MAGIC_HIT: string;
	MEDIUM_WATER_HIT: string;
	MEDIUM_DARKNESS_HIT: string;
	MEDIUM_KICK: string;
	MEDIUM_POISON_HIT: string;
	MEDIUM_PUNCH: string;
	MEDIUM_SLAM: string;
	MEDIUM_SLICE: string;
	MEDIUM_WHACK: string;
	MENU_CANCEL: string;
	MENU_CLICK: string;
	MENU_COSTUME_DOWN: string;
	MENU_COSTUME_UP: string;
	MENU_ERROR: string;
	MENU_HOVER: string;
	MENU_ICON_ENTER: string;
	MENU_SELECT: string;
	MENU_SIDES_CLOSE: string;
	MENU_STAGE_BACK: string;
	MENU_STAGE_ENTER: string;
	MENU_STAGE_SELECT: string;
	MENU_STARTUP: string;
	ROLL: string;
	SHIELD_HIT_0: string;
	SHIELD_HIT_1: string;
...
declare type TGlobalSfx = {
	constructor();
	ASSIST_CALL: string;
	ASSIST_CHARGED_P1: string;
	ASSIST_CHARGED_P2: string;
	ASSIST_CHARGED_P3: string;
	ASSIST_CHARGED_P4: string;
	AIRDASH: string;
	PARRY: string;
	HIT_LIGHT: string;
	HIT_MEDIUM: string;
	 ...
	 * Translates constant to a user-readable string.
	 */
	constToString(value: string): string;
}
...
declare var EntityHitCondition:EntityHitCondition;
declare type EntityHitCondition = TEntityHitCondition & {
	constructor();
	/**
	 * No condition.
	 */
...
declare interface CharacterStats extends GameObjectStats, TCharacterStats {
	...
	wallJumpXSpeed: number;
	/**
	 * The vertical speed of a wall jump, positive values send the character upwards.
	 */
	wallJumpYSpeed: number;
}
...
declare interface HitboxStats extends JSONClass, THitboxStats {
	...
	jabResetType: number;
	/**
	 * Whether or not the hitbox should interact with certain foes depending on their physics state. Multiple conditions can be combined using the | operator.
	 * For more complex conditions, should use the HITBOX_CONNECTED event to update the disabled field of hitbox stats.
	 *
	 * @see PhysicsHitCondition
	 */
	physicsHitConditions: number;
	/**
	 * Whether or not the hitbox should interact with foes of a certain object type. Multiple conditions can be combined using the | operator.
	 * For more complex conditions, should use the HITBOX_CONNECTED event to update the disabled field of hitbox stats.
	 *
	 * @see EntityHitCondition
	 */
	entityHitConditions: number;
	/**
...
declare type StatusEffectType = TStatusEffectType & {
	...
	AUTOLINK_KNOCKBACK_MULTIPLIER: number;
	DODGE_ROLL_SPEED_MULTIPLIER: number;
	LEDGE_JUMP_SPEED_MULTIPLIER: number;
	CUSTOM: number;
	/**
	 * Translates constant to a user-readable string.
	 */
...
declare type TStatusEffectType = {
	...
	ROLL_SLIDE_OFF_SPEED_MULTIPLIER: number;
	AIRDASH_SPEED_CAP_MULTIPLIER: number;
	AIRDASH_ACCEL_MULTIPLIER: number;
	AIRDASH_ENDLAG_SPEED_MULTIPLIER: number;
	PHYSICS_SCALE: number;
	/**
	 * Translates constant to a user-readable string.
	 */
	constToString(value: number): string;
...
declare class LineSegmentStructure extends Structure {
	 ...
	 * @return An Array of two points or null if none are found.
	 */
	getSegmentPointsByPoint(point: TPoint): Point[];
}

declare class CustomLineSegmentStructure extends LineSegmentStructure {
...
declare class Score extends ApiObject {
	/**
	 * Total damage taken by other characters, split up by port.
	 */
	damageTakenTotal: number[];
	/**
	 * Total damage given to other characters, split up by port.
	 */
	damageGivenTotal: number[];
	/**
	 * Total damage taken by other characters, this life, split up by port.
	 */
	damageTakenThisLife: number[];
	/**
	 * Total damage given to other characters, this life, split up by port.
	 */
	damageGivenThisLife: number[];
	/**
	 * Frames since this player last took damage
	 */
	framesSinceDamageTaken: number;
	/**
	 * Keeps track of successful shields since last damage given / received
	 */
	shieldCombo: number;
	/**
	 * Total Falls
	...
	falls: number;
	/**
	 * Total Self Destructs
	 */
	selfDestructs: number;
	/**
	 * Time elapsed when you were defeated
	 */
	timeDefeated: number;
	/**
	 * Total ko's
...
declare class PhysicsHitCondition {
	protected constructor();
	/**
	 * No condition.
	 */
...
declare class ScoreEvent extends CustomEvent {
	readonly data: {foe?: GameObject, self?: Entity, state?: number, value?: number};
	...
	static readonly ATTACK_LANDED: number;
	/**
	 * Translates constant to a user-readable string.
	 */
	static constToString(value: number): string;
...
declare class StatusEffect extends ASerializable {
	constructor();
	values: {id: string, options?: {fields?: {frameTimer?: TFrameTimer}, metadata?: any, params?: {collisionBoxType?: number, interval?: number}, tag?: string}, type: number, value: number}[];
	getSum(): number;
	getProduct(): number;
}
